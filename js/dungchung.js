...
function convertPriceStringToInt(priceString) {
    // Loại bỏ các dấu chấm trong chuỗi
    let cleanedString = priceString.replace(/\./g, '');
    // Chuyển đổi chuỗi thành số nguyên
    let priceInt = parseInt(cleanedString, 10);
    return priceInt;
}
...
function getRandomOrderId() {
    return Math.floor(10000 + Math.random() * 90000000);
}
// ============== ALert Box ===============
